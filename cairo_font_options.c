...
/* $Id: cairo_font_options.c 310358 2011-04-19 14:53:26Z mgdm $ */
...
#endif
	retval.handle = zend_objects_store_put(font_options, NULL, (zend_object_handlers)cairo_font_options_object_destroy, NULL TSRMLS_CC);
