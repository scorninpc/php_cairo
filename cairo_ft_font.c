...
/* $Id: cairo_ft_font.c 321481 2011-12-28 17:30:24Z mgdm $ */
...
#endif
	retval.handle = zend_objects_store_put(font_face, NULL, (zend_object_handlers)cairo_ft_font_face_object_destroy, NULL TSRMLS_CC);
