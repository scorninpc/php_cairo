...
/* $Id: cairo_surface.c 323233 2012-02-15 16:13:25Z mgdm $ */
...
#endif
	retval.handle = zend_objects_store_put(surface, NULL, (zend_object_handlers)cairo_surface_object_destroy, NULL TSRMLS_CC);
