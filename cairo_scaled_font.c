...
/* $Id: cairo_scaled_font.c 314889 2011-08-14 00:25:48Z mgdm $ */
...
static zend_object cairo_scaled_font_object_new(zend_class_entry *ce TSRMLS_DC)
{
	zend_object retval;
...
#endif
	retval.handle = zend_objects_store_put(scaled_font, NULL, (zend_object_handlers)cairo_scaled_font_object_destroy, NULL TSRMLS_CC);
