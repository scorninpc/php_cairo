...
/* $Id: cairo_matrix.c 310358 2011-04-19 14:53:26Z mgdm $ */
...
#endif
	retval.handle = zend_objects_store_put(matrix, NULL, (zend_object_handlers)cairo_matrix_object_destroy, NULL TSRMLS_CC);
