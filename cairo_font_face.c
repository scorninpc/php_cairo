...
/* $Id: cairo_font_face.c 310358 2011-04-19 14:53:26Z mgdm $ */
 ...
 */
zend_object cairo_font_face_object_new(zend_class_entry *ce TSRMLS_DC)
{
	zend_object retval;
...
#endif
	retval.handle = zend_objects_store_put(font_face, NULL, (zend_object_handlers)cairo_font_face_object_destroy, NULL TSRMLS_CC);
